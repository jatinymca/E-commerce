...
<!-- Mirrored from loopinfosol.in/themeforest/ekka-html-v33/ekka-admin/sub-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Dec 2022 06:48:59 GMT -->
<head>
	<meta charset="utf-8" />
									...
									<div class="ec-cat-form">
										...
										<form id="sub_category_post">
											...
											<div class="form-group row">
												...
												<?php 
												// echo	$sql="SELECT `unique_id` FROM `main_category` ";
												// 	$qry1=mysqli_query($conn,$sql);
												// 	$row=mysqli_fetch_array($qry1);
												// 	$unique_id=$row['unique_id'];
												// 	echo "<input type=\"hidden\" class=\"form-control\" value=\"'$unique_id'\"  name=\"unique_id\">";
													?>
											<div class="form-group row">
												<label for="parent-category" class="col-12 col-form-label">Parent Category</label> 
												<div class="col-12">
													<select   id="Parent_Category"name="Parent_uniqueid" class="custom-select">
													<?php 
													$sql="SELECT `Name`,`unique_id` FROM `main_category` ";
													$qry=mysqli_query($conn,$sql);
													while($row=mysqli_fetch_array($qry)) {
																$Name=$row['Name'];
																$unique_id=$row['unique_id'];
														 
													echo"<option value='".$unique_id."'>".$Name."</option>"; }?>
